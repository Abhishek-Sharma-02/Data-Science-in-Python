...
plt.axvline(houses['SalePrice'].mean()+houses['SalePrice'].std(ddof=0),label='Standard deviation',color='Red')
...
z_by_location = {}
for data,neighborhood in [(north_ames, 'NAmes'), (clg_creek, 'CollgCr'),(old_town, 'OldTown'), (edwards, 'Edwards'),(somerset, 'Somerst')]:
